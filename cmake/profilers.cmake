# To enable tracy profiler, build project with STL_ENABLE_TRACY=ON
...
OPTION(STL_ENABLE_TRACY "If set, enables tracy profiler and adds function to enable tracy for projects." OFF)
if (NOT STL_ENABLE_TRACY)
    return()
endif()
